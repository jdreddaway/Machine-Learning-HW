 ...
 * @version 1.0
 */
public class CustomAdaBoostClassifier extends AbstractConditionalDistribution implements FunctionApproximater  {
    /**
	 * 
	 */
	private static final long serialVersionUID = -6037947319067954334L;
	...
	private Supplier<FunctionApproximater> classifierFactory;
	
	/**
     * Create a new decision stump ensemble
     * @param size the number of stumps
     */
    public CustomAdaBoostClassifier(int size) {
        this(size, DecisionStumpClassifier::new);
    }

    /**
     * Create a new decision stump ensemble
     * @param size the number of stumps
     * @param classifierFactory supplies the classifier class to use
     */
    public CustomAdaBoostClassifier(int size, Supplier<FunctionApproximater> classifierFactory) {
        this.size = size;
     ...
     */
    public CustomAdaBoostClassifier() {
        this(100);
    }
    ...
    public void estimate(DataSet instances) {
        ...
        for (int i = 0; i < classifiers.length; i++) {
			...
			classifiers[i] = classifierFactory.get();
