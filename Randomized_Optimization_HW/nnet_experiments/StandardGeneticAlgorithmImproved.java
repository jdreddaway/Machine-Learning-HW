 ...
 * @version 1.0
 */
public class StandardGeneticAlgorithmImproved extends OptimizationAlgorithm {
     ...
     */
    public StandardGeneticAlgorithmImproved(int populationSize, int toMate, int toMutate, GeneticAlgorithmProblem gap) {
        super(gap);
        this.toMate = toMate;
